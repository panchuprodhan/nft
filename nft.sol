...
contract NFTToken is ERC721URIStorage {
    ...
    event MintNFT(uint256 _newItemId, string chainName, string assetNameInEvent, string message);
    // event URIexists(string message);
    ...
    function mintNFT(
        ...
        // if (_uriToTokenId[tokenURI] == 0) {
        //     emit URIexists("Not Able to mint the asset, as it is already minted.");
        // }
        require(_uriToTokenId[tokenURI] == 0, "The URL already exists, kindly mint with a new URL.");
